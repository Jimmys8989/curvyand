  ...
  return (
    <div className="relative space-y-1.5" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-lg border border-[#E7E2D8] bg-white px-3 py-2 text-xs sm:text-sm font-semibold text-neutral-800 transition-all focus:border-[#9E5A44] focus:outline-hidden text-left cursor-pointer hover:bg-[#FAF7F2]/40"
      >
        <span className="flex items-center space-x-2.5">
          <BrandLogo
            name={selectedBrand.name}
            logoUrl={selectedBrand.logo}
            siteUrl={selectedBrand.siteUrl}
              ...
              filteredBrands.map((brand, idx) => {
                ...
                return (
                  <li
                    ...
                    className={`flex items-center justify-between px-3.5 py-2 cursor-pointer text-xs font-sans transition-colors ${
