...
import { Star, ArrowUp, ArrowDown, Search, Filter, Compass, Bookmark, DollarSign, Tag, HelpCircle, ThumbsUp, ThumbsDown } from "lucide-react";
        ...
        {filteredBrands.length > 0 ? (
          filteredBrands.map((brand, index) => {
            ...
            return (
              ...
              >
                {/* 1. Rank */}
                <div className="col-span-1 flex lg:flex-col items-center justify-between lg:justify-center pb-3 lg:pb-0 border-b lg:border-b-0 border-[#E7E2D8]">
                ...
                {/* 3. Segment Category */}
                <div className="col-span-1 flex flex-wrap gap-1 lg:justify-center">
                  <span className="text-[10px] uppercase font-display font-bold text-neutral-400 block lg:hidden w-full mb-1">
                    Category
                  </span>
                  <span className="px-2 py-0.5 rounded bg-[#FAF7F2] border border-[#E7E2D8] text-[9px] text-neutral-600 font-display font-bold uppercase tracking-wider text-center w-full block">
                    {getCategoryTitle(brand.category).split(" ")[0]}
                  </span>
                </div>

                {/* 4. Sizing Range */}
                <div className="col-span-2 lg:text-center">
                  <span className="text-[10px] uppercase font-display font-bold text-neutral-400 block lg:hidden mb-1">
                    Size Range
                  </span>
                ...
                {/* 5. Price Tier */}
                <div className="col-span-1 lg:text-center flex flex-col lg:items-center justify-center">
                  <span className="text-[10px] uppercase font-display font-bold text-neutral-400 block lg:hidden mb-1">
                    Price Tier
                  </span>
                  <span className="text-xs font-mono font-bold text-[#9E5A44] tracking-widest bg-[#EEDCD2]/30 px-2.5 py-1 rounded-md border border-[#E7E2D8]/30">
                    {"$".repeat(brand.priceTier)}
                  </span>
                  <span className="text-[8px] text-neutral-400 font-display font-bold uppercase tracking-wider mt-1 hidden lg:block">
                    {brand.priceTier === 1 ? "Budget" : brand.priceTier === 2 ? "Moderate" : brand.priceTier === 3 ? "Premium" : "Luxury"}
                  </span>
                </div>

                {/* 6. Sizing Accuracy Vote */}
                <div className="col-span-2 flex flex-col items-center justify-between lg:justify-center space-y-1 mt-2 lg:mt-0 pb-3 lg:pb-0 border-b lg:border-b-0 border-[#E7E2D8]/50 lg:text-center">
                  ...
                  <div className="flex items-center space-x-2 justify-center w-full">
                    ...
                    >
                      ...
                      <span className="text-[10px] font-mono font-bold whitespace-nowrap">
                        {brand.votesUp !== undefined ? brand.votesUp : brand.votes}
                      </span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-[10px] font-mono font-bold whitespace-nowrap">
                        {brand.votesDown !== undefined ? brand.votesDown : 0}
                      </span>
                    </button>
                  </div>
                ...
                {/* 7. Community Rating */}
                <div className="col-span-1 text-center flex flex-col items-center justify-center lg:mt-0 mt-2 pb-3 lg:pb-0 border-b lg:border-b-0 border-[#E7E2D8]/50">
                  <span className="text-[10px] uppercase font-display font-bold text-neutral-400 block lg:hidden w-full text-left mb-1">
                    Community Rating
                  </span>
                ...
                {/* 8. Action explore */}
                <div className="col-span-1 text-right flex justify-between lg:justify-end items-center mt-3 lg:mt-0 pt-3 lg:pt-0">
